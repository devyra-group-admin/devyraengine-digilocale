...
const AccommodationDetails = ({
  ...
  return (
    <>
      <div className="fixed md:relative bottom-0 md:bottom-auto left-0 md:left-auto right-0 md:right-auto w-full md:w-[400px] bg-white flex flex-col border-t md:border-t-0 md:border-l border-gray-200 shadow-2xl md:shadow-xl overflow-y-auto max-h-[55vh] md:max-h-none md:h-full z-[1000] md:z-20 font-sans rounded-t-3xl md:rounded-none animate-slideInFromBottom">
        {/* Mobile Drag Handle */}
